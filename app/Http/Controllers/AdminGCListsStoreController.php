...
class AdminGCListsStoreController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
		...
		*/
		...
		if(CRUDBooster::getCurrentMethod() == 'getIndex'){
			...
			$this->index_button[] = ['label'=>'Create GC','url'=>url("qr_link/tasteless/$store_concept->name"),"icon"=>"fa fa-qrcode", 'color'=>'success'];
		}
	...
	*/
	...
	public function createEGC(Request $request){
		...
		$url = url("qr_link/tasteless/$sc_name/$gclist_devp->customer_reference_number");
