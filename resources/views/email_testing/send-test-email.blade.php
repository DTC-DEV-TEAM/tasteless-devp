        ...
        <tr>
            <td align="center">
                <div class="container">
                    ...
                    @else
                        <img src="{{ $message->embed(public_path() . '/store_logo/img/store.jpg') }}" width="800" style="max-height: 800px; min-width: 800px; object-fit: contain; text-align: center; margin-top: 5px;" />
                        <img src="{{ $message->embed(public_path() . '/store_logo/img/store_terms_and_conditions.jpg') }}" width="800" style="max-height: 800px; min-width: 800px; object-fit: contain; text-align: center; margin-top: 5px;" />
                        <img src="{{ $message->embed(public_path() . '/store_logo/img/store_claiming.jpg') }}" width="800" style="max-height: 800px; min-width: 800px; object-fit: contain; text-align: center; margin-top: 5px;" />
                    @endif
