                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table default-table-design">
                            ...
                            <tr>
                                <td class="text-center table-label"><span class="required">*</span> Batch Group:</td>
                                <td style="width: 200px;">
                                    <input class="input" type="number" name="batch_group" placeholder="Batch Group" required>
                                </td>
                                <td class="text-center table-label"><span class="required">*</span> Company Name:</td>
                                <td style="width: 200px;">
                            ...
                            <tr>
                                <td class="text-center table-label"><span class="required">*</span> PO Number:</td>
                                <td style="width: 200px;">
                                    <input class="input" type="text" name="po_number" placeholder="PO number">
                                </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="file-upload-content">
                                    ...
                                    <input type="file" name="po_attachment" accept=".pdf" multiple>
                                </div>
                            </div>
                        </div>
                        <br>
